...
<script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
    ...
    <aside id="profile">
        <form method="post" action="courseRegScript.php" enctype="multipart/form-data">
			<h3 style="font-weight:bold; text-align:center;">CREATE COURSE</h3><br>
			...
			<div class="input-group">
                <label for="formFile" class="form-label" style="text-align:left">Student List</label>
                <input class="form-control" type="file" name="formFile" id="formFile">
            </div><br><br>
            <div class="input-group">
				<button type="submit" name="submit" value="Reg" class="btn" style="color: white; background: #FE20CE; margin-left:100px;">  CREATE  </button>
			</div><br>
		</form>
	</aside>
</body>
