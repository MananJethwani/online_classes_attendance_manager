...
<script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
    ...
    <aside id="profile">
        <form method="post" action="attendance.php" enctype="multipart/form-data">
			<h3 style="font-weight:bold; text-align:center;">ATTENDANCE</h3><br>
			<div class="input-group">
                <label for="Email" class="sr-only">Course Id</label>
                <input name="courseName" type="text" id="courseName" class="form-control" placeholder="Course Name" required autofocus style="width:293px;">
			</div><br>
			<div class="input-group">
                <label for="zoomFile" class="form-label" style="text-align:left">Zoom Chat</label>
                <input class="form-control" type="file" name="zoomFile" id="zoomFile">
            </div><br><br>
            <div class="input-group">
				<button type="submit" name="submit" value="Reg" class="btn" style="color: white; background: #FE20CE; margin-left:100px;">  UPDATE </button>
			</div><br>
		</form>
	</aside>
</body>
